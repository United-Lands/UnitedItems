...
public class RefreshItemCommand implements CommandExecutor {

    private final UnitedItems plugin;
    private final MessageProvider messageProvider;

    public RefreshItemCommand(UnitedItems plugin, MessageProvider messageProvider) {
        this.plugin = plugin;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label,
        ...
        var updated = ItemUpdater.refreshitem(plugin, messageProvider, player, heldItem, true);
